...
Redirection rules are matched entirely on your device — no URL or page content is ever transmitted by that feature. Redirector does send one anonymous daily usage ping (install count and version only, no browsing data). See [PRIVACY.md](./PRIVACY.md) for the full policy.
