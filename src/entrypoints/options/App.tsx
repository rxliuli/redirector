...
import { Toaster } from "$lib/components/extra/Toaster";
import { Button } from "$lib/components/ui/button";
import { useApplySystemTheme } from "$lib/hooks/use-theme";
import type { MatchRule } from "$lib/url";
import Dataset from "./components/Dataset";
import RuleDialog from "./components/RuleDialog";
import { addRule, isStorageQuotaExceededError, useRules } from "./store";
	...
	return (
		<>
			<div className="mx-auto w-full max-w-7xl p-2 md:p-4">
				<div className="mb-4">
					<div className="flex items-center gap-2">
						<div className="mr-auto">
							<span className="text-xl font-bold">Redirector</span>
							<a
						...
						<a href="https://discord.gg/gFhKUthc88" target="_blank">
							<Button variant="secondary">
								<svg
									...
									viewBox="0 0 640 512"
									className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 text-blue-500 transition-all"
								>
									<path
				...
				<div>
					<Dataset onAddRule={() => setAddDialogOpen(true)} />
				</div>
			</div>
