...
beforeEach(async () => {
  ...
  rules.set([])
  // The edit dialog is fullscreen below the md breakpoint; several tests
  // click table rows / the actions menu while it is open, which needs the
  // desktop layout where the dialog leaves the Action column visible.
...
describe('List', () => {
  ...
  it('render large dataset', async () => {
    ...
    rules.set(list)
    await render(<Dataset onAddRule={() => {}} />)
